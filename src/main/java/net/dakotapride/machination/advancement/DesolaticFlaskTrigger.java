...
public class DesolaticFlaskTrigger extends SimpleCriterionTrigger<DesolaticFlaskTrigger.TriggerInstance> {
    private static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(Machination.MOD_ID, "desolatic_flask");
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance {
        public TriggerInstance(ContextAwarePredicate player) {
            super(DesolaticFlaskTrigger.ID, player);
        }
