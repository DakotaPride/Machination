...
public class FinalStandTrigger extends SimpleCriterionTrigger<FinalStandTrigger.TriggerInstance> {
    private static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(Machination.MOD_ID, "final_stand");
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance {
        public TriggerInstance(ContextAwarePredicate player) {
            super(FinalStandTrigger.ID, player);
        }
