...
public class InfectTrigger extends SimpleCriterionTrigger<InfectTrigger.TriggerInstance> {
    private static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(Machination.MOD_ID, "infect_used");
