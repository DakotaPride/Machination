...
public class SkewerTrigger extends SimpleCriterionTrigger<SkewerTrigger.TriggerInstance> {
    private static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(Machination.MOD_ID, "skewer");
