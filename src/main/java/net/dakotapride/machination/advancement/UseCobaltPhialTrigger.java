...
public class UseCobaltPhialTrigger extends SimpleCriterionTrigger<UseCobaltPhialTrigger.TriggerInstance> {
    private static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(Machination.MOD_ID, "use_cobalt_phial");
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance {
        public TriggerInstance(ContextAwarePredicate player) {
            super(UseCobaltPhialTrigger.ID, player);
        }
