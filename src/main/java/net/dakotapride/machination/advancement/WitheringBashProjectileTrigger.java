...
public class WitheringBashProjectileTrigger extends SimpleCriterionTrigger<WitheringBashProjectileTrigger.TriggerInstance> {
    private static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(Machination.MOD_ID, "withering_bash_projectile");
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance {
        public TriggerInstance(ContextAwarePredicate player) {
            super(WitheringBashProjectileTrigger.ID, player);
        }
