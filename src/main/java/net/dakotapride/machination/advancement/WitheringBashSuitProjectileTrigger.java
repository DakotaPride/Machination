...
public class WitheringBashSuitProjectileTrigger extends SimpleCriterionTrigger<WitheringBashSuitProjectileTrigger.TriggerInstance> {
    private static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(Machination.MOD_ID, "withering_bash_suit");
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance {
        public TriggerInstance(ContextAwarePredicate player) {
            super(WitheringBashSuitProjectileTrigger.ID, player);
        }
